...
-- ============================================================
--  Note: Triggers (trg_detect_recurring, trg_feedback_on_resolve)
--  are intentionally omitted here since they require DELIMITER
--  blocks that Railway's MySQL setup (run via Python/pymysql)
--  cannot execute. Apply them manually via a MySQL client if
--  you need chronic-issue detection / auto feedback flags.
-- ============================================================
